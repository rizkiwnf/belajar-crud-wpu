    ...
    <div class="flex min-h-full items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div class="w-full max-w-md space-y-8">
            @if (session()->has('success'))
                <div class="mb-3 hidden font-semibold w-full items-center rounded-lg bg-green-300 px-6 py-5 text-base text-green-800 data-[te-alert-show]:inline-flex"
            ...
            <div class="mb-3 hidden font-semibold w-full items-center rounded-lg bg-red-300 px-6 py-5 text-base text-red-800 data-[te-alert-show]:inline-flex"
                role="alert" data-te-alert-init data-te-alert-show>
                {{ session('loginError') }}
                <button type="button"
                    class="ml-auto box-content rounded-none border-none p-1 text-warning-900 opacity-50 hover:text-warning-900 hover:no-underline hover:opacity-75 focus:opacity-100 focus:shadow-none focus:outline-none"
                ...
                <div class="-space-y-px rounded-md shadow-sm">
                    ...
                    <div>
                        ...
                        <input id="password" name="password" type="password" autocomplete="current-password" required
                            class="relative block w-full rounded-lg border-0 py-1.5 px-2 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
